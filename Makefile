...
REVEALTEST   := extra-scripts highlightjs klipsify klipsify-python multiplex noslide options reveal-toc revealjs4 slide-numbers slide-numbers-toc slide-numbers-reveal-toc split title-slide
