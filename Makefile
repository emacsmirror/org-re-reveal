...
REVEALTEST   := blockquote extra-scripts highlightjs internal-links klipsify klipsify-python merge-classes multiplex noslide options pdf-notes reveal-toc revealjs4 src-blocks-hl src-blocks-no-hl slide-numbers slide-numbers-toc slide-numbers-reveal-toc split title-slide title-slide-notes
