...
*WARNING!*  This project is not yet usable.  Please wait until this
warning is gone before trying it out.  Contrary to the statements
below, it is not yet used in emacs-reveal.

This project was forked from ~org-reveal~ and is /not/ yet available on
MELPA.  Thus, you need to clone the following repository:
#+BEGIN_SRC sh
git clone https://gitlab.com/oer/org-revealjs.git
#+END_SRC

Actually, if you are interested in ~org-revealjs~, I suggest that you take
...
** Install org-revealjs from GitLab
   ...
   You can install the latest version of [[https://gitlab.com/oer/org-revealjs][org-revealjs from GitLab]].
...
#+REVEAL_HTML: <iframe width="400" height="300" src="https://archive.org/download/LinusTorvaldsOnGittechTalk/LinusTorvaldsOnGittechTalk.ogv" frameborder="0" allowfullscreen></iframe>
** Speaker Notes
