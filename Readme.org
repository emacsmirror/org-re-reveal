...
The project org-re-reveal started as fork of
...
embeds (or should do so shortly) org-re-reveal, reveal.js, and useful
...
** Install org-re-reveal from MELPA
   ...
   org-re-reveal is provided as MELPA package.  Use of MELPA requires
...
*** Url form for file location
    ...
    Ubuntu would be "file:///home/username/org-re-reveal/Readme.org" and
...
** Editable Source Code
   ...
   with ~org-re-reveal-klipsify-src~.  At present code editing is
...
*** Easy-Template for Speaker Notes
    ...
    org-re-reveal registers 'n' as the key for speaker notes easy-template.
...
** Multiplexing
   ...
   *Warning!* The following is untested with ~org-re-reveal~!
...
** Executable Source Blocks
   ...
   klipse plugin by setting ~org-re-reveal-klipsify-src~ to non-nil.
