...
*** Customize the Title Slide
    ...
    3.25.0; see [[https://gitlab.com/oer/org-re-reveal/-/blob/master/test-cases/test-title-slide-notes-2.org][test-title-slide-notes-2.org]]
...
** Slide Containers
   ...
   See [[https://gitlab.com/oer/org-re-reveal/-/blob/master/test-cases/test-slide-container.org][this slide container test case]]
   and [[https://gitlab.com/oer/org-re-reveal/-/blob/master/test-cases/test-slide-grid-wrapper.org][that slide grid test case]].
...
#+END_SRC
    See also
    [[https://gitlab.com/oer/org-re-reveal/-/blob/master/test-cases/test-plugin-css.org][this
...
*** Text-To-Speech (TTS) for Speaker Notes
    ...
    [[https://gitlab.com/oer/org-re-reveal/-/blob/master/test-cases/test-notes-for-tts.org][this sample presentation]]
