...
#+MACRO: klipse-languages (eval (message "%s" org-re-reveal-klipse-languages))
** Editable and Executable Source Code
   ...
   supported in: {{{klipse-languages}}}

   Some example follow in the Tips section under [[Executable Source Blocks]].
